...
syn match ngxReservedVariable '\$ancient_browser\>'
syn match ngxReservedVariable '\$arg_\>'
syn match ngxReservedVariable '\$args\>'
syn match ngxReservedVariable '\$binary_remote_addr\>'
syn match ngxReservedVariable '\$binary_remote_addr\>'
syn match ngxReservedVariable '\$body_bytes_sent\>'
syn match ngxReservedVariable '\$bytes_sent\>'
syn match ngxReservedVariable '\$bytes_sent\>'
syn match ngxReservedVariable '\$bytes_sent\>'
syn match ngxReservedVariable '\$connection\>'
syn match ngxReservedVariable '\$connection\>'
syn match ngxReservedVariable '\$connection\>'
syn match ngxReservedVariable '\$connection_requests\>'
syn match ngxReservedVariable '\$connection_requests\>'
syn match ngxReservedVariable '\$connections_active\>'
syn match ngxReservedVariable '\$connections_reading\>'
syn match ngxReservedVariable '\$connections_waiting\>'
syn match ngxReservedVariable '\$connections_writing\>'
syn match ngxReservedVariable '\$content_length\>'
syn match ngxReservedVariable '\$content_type\>'
syn match ngxReservedVariable '\$cookie_\>'
syn match ngxReservedVariable '\$date_gmt\>'
syn match ngxReservedVariable '\$date_local\>'
syn match ngxReservedVariable '\$document_root\>'
syn match ngxReservedVariable '\$document_uri\>'
syn match ngxReservedVariable '\$fastcgi_path_info\>'
syn match ngxReservedVariable '\$fastcgi_script_name\>'
syn match ngxReservedVariable '\$geoip_area_code\>'
syn match ngxReservedVariable '\$geoip_area_code\>'
syn match ngxReservedVariable '\$geoip_city\>'
syn match ngxReservedVariable '\$geoip_city\>'
syn match ngxReservedVariable '\$geoip_city_continent_code\>'
syn match ngxReservedVariable '\$geoip_city_continent_code\>'
syn match ngxReservedVariable '\$geoip_city_country_code\>'
syn match ngxReservedVariable '\$geoip_city_country_code\>'
syn match ngxReservedVariable '\$geoip_city_country_code3\>'
syn match ngxReservedVariable '\$geoip_city_country_code3\>'
syn match ngxReservedVariable '\$geoip_city_country_name\>'
syn match ngxReservedVariable '\$geoip_city_country_name\>'
syn match ngxReservedVariable '\$geoip_country_code\>'
syn match ngxReservedVariable '\$geoip_country_code\>'
syn match ngxReservedVariable '\$geoip_country_code3\>'
syn match ngxReservedVariable '\$geoip_country_code3\>'
syn match ngxReservedVariable '\$geoip_country_name\>'
syn match ngxReservedVariable '\$geoip_country_name\>'
syn match ngxReservedVariable '\$geoip_dma_code\>'
syn match ngxReservedVariable '\$geoip_dma_code\>'
syn match ngxReservedVariable '\$geoip_latitude\>'
syn match ngxReservedVariable '\$geoip_latitude\>'
syn match ngxReservedVariable '\$geoip_longitude\>'
syn match ngxReservedVariable '\$geoip_longitude\>'
syn match ngxReservedVariable '\$geoip_org\>'
syn match ngxReservedVariable '\$geoip_org\>'
syn match ngxReservedVariable '\$geoip_postal_code\>'
syn match ngxReservedVariable '\$geoip_postal_code\>'
syn match ngxReservedVariable '\$geoip_region\>'
syn match ngxReservedVariable '\$geoip_region\>'
syn match ngxReservedVariable '\$geoip_region_name\>'
syn match ngxReservedVariable '\$geoip_region_name\>'
syn match ngxReservedVariable '\$gzip_ratio\>'
syn match ngxReservedVariable '\$host\>'
syn match ngxReservedVariable '\$hostname\>'
syn match ngxReservedVariable '\$hostname\>'
syn match ngxReservedVariable '\$http2\>'
syn match ngxReservedVariable '\$http_\>'
syn match ngxReservedVariable '\$https\>'
syn match ngxReservedVariable '\$invalid_referer\>'
syn match ngxReservedVariable '\$is_args\>'
syn match ngxReservedVariable '\$limit_rate\>'
syn match ngxReservedVariable '\$memcached_key\>'
syn match ngxReservedVariable '\$modern_browser\>'
syn match ngxReservedVariable '\$msec\>'
syn match ngxReservedVariable '\$msec\>'
syn match ngxReservedVariable '\$msec\>'
syn match ngxReservedVariable '\$msie\>'
syn match ngxReservedVariable '\$nginx_version\>'
syn match ngxReservedVariable '\$nginx_version\>'
syn match ngxReservedVariable '\$pid\>'
syn match ngxReservedVariable '\$pid\>'
syn match ngxReservedVariable '\$pipe\>'
syn match ngxReservedVariable '\$pipe\>'
syn match ngxReservedVariable '\$proxy_add_x_forwarded_for\>'
syn match ngxReservedVariable '\$proxy_host\>'
syn match ngxReservedVariable '\$proxy_port\>'
syn match ngxReservedVariable '\$proxy_protocol_addr\>'
syn match ngxReservedVariable '\$proxy_protocol_port\>'
syn match ngxReservedVariable '\$query_string\>'
syn match ngxReservedVariable '\$realip_remote_addr\>'
syn match ngxReservedVariable '\$realip_remote_port\>'
syn match ngxReservedVariable '\$realpath_root\>'
syn match ngxReservedVariable '\$remote_addr\>'
syn match ngxReservedVariable '\$remote_addr\>'
syn match ngxReservedVariable '\$remote_port\>'
syn match ngxReservedVariable '\$remote_port\>'
syn match ngxReservedVariable '\$remote_user\>'
syn match ngxReservedVariable '\$request\>'
syn match ngxReservedVariable '\$request_body\>'
syn match ngxReservedVariable '\$request_body_file\>'
syn match ngxReservedVariable '\$request_completion\>'
syn match ngxReservedVariable '\$request_filename\>'
syn match ngxReservedVariable '\$request_id\>'
syn match ngxReservedVariable '\$request_length\>'
syn match ngxReservedVariable '\$request_length\>'
syn match ngxReservedVariable '\$request_method\>'
syn match ngxReservedVariable '\$request_time\>'
syn match ngxReservedVariable '\$request_time\>'
syn match ngxReservedVariable '\$request_uri\>'
syn match ngxReservedVariable '\$scheme\>'
syn match ngxReservedVariable '\$secure_link\>'
syn match ngxReservedVariable '\$secure_link_expires\>'
syn match ngxReservedVariable '\$sent_http_\>'
syn match ngxReservedVariable '\$server_addr\>'
syn match ngxReservedVariable '\$server_addr\>'
syn match ngxReservedVariable '\$server_name\>'
syn match ngxReservedVariable '\$server_port\>'
syn match ngxReservedVariable '\$server_port\>'
syn match ngxReservedVariable '\$server_protocol\>'
syn match ngxReservedVariable '\$session_log_binary_id\>'
syn match ngxReservedVariable '\$session_log_id\>'
syn match ngxReservedVariable '\$slice_range\>'
syn match ngxReservedVariable '\$spdy\>'
syn match ngxReservedVariable '\$spdy_request_priority\>'
syn match ngxReservedVariable '\$ssl_cipher\>'
syn match ngxReservedVariable '\$ssl_cipher\>'
syn match ngxReservedVariable '\$ssl_client_cert\>'
syn match ngxReservedVariable '\$ssl_client_fingerprint\>'
syn match ngxReservedVariable '\$ssl_client_i_dn\>'
syn match ngxReservedVariable '\$ssl_client_raw_cert\>'
syn match ngxReservedVariable '\$ssl_client_s_dn\>'
syn match ngxReservedVariable '\$ssl_client_serial\>'
syn match ngxReservedVariable '\$ssl_client_verify\>'
syn match ngxReservedVariable '\$ssl_protocol\>'
syn match ngxReservedVariable '\$ssl_protocol\>'
syn match ngxReservedVariable '\$ssl_server_name\>'
syn match ngxReservedVariable '\$ssl_server_name\>'
syn match ngxReservedVariable '\$ssl_session_id\>'
syn match ngxReservedVariable '\$ssl_session_id\>'
syn match ngxReservedVariable '\$ssl_session_reused\>'
syn match ngxReservedVariable '\$ssl_session_reused\>'
syn match ngxReservedVariable '\$status\>'
syn match ngxReservedVariable '\$status\>'
syn match ngxReservedVariable '\$tcpinfo_rtt\>'
syn match ngxReservedVariable '\$tcpinfo_rttvar\>'
syn match ngxReservedVariable '\$tcpinfo_snd_cwnd\>'
syn match ngxReservedVariable '\$tcpinfo_rcv_space\>'
syn match ngxReservedVariable '\$time_iso8601\>'
syn match ngxReservedVariable '\$time_iso8601\>'
syn match ngxReservedVariable '\$time_iso8601\>'
syn match ngxReservedVariable '\$time_local\>'
syn match ngxReservedVariable '\$time_local\>'
syn match ngxReservedVariable '\$time_local\>'
syn match ngxReservedVariable '\$uid_got\>'
syn match ngxReservedVariable '\$uid_reset\>'
syn match ngxReservedVariable '\$uid_set\>'
syn match ngxReservedVariable '\$upstream_addr\>'
syn match ngxReservedVariable '\$upstream_cache_status\>'
syn match ngxReservedVariable '\$upstream_connect_time\>'
syn match ngxReservedVariable '\$upstream_cookie_\>'
syn match ngxReservedVariable '\$upstream_header_time\>'
syn match ngxReservedVariable '\$upstream_http_\>'
syn match ngxReservedVariable '\$upstream_response_length\>'
syn match ngxReservedVariable '\$upstream_response_time\>'
syn match ngxReservedVariable '\$upstream_status\>'
syn match ngxReservedVariable '\$uri\>'
...
syn keyword ngxDirective scgi_pass
...
syn keyword ngxDirective split_clients
...
syn keyword ngxDirective stream
...
hi link ngxReservedVariable Boolean
